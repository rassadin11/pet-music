...
const SongPage = () => {
  ...
  if (!track)
    return <p className={s.wrapper}>Track was not founded</p>
      ...
      {track && (
        <div className={s.wrapper}>
          ...
          {track.wiki?.content ? (
            ...
            <p className={s.error}>
              Unfortunately, there are not info about this track in
              english. Try to find info in other places :(
            </p>
          )}
        </div>
      )}
